package com.nomanr.components.slider
...
import com.nomanr.components.internal.IncreaseHorizontalSemanticsBounds
import com.nomanr.components.internal.awaitHorizontalPointerSlopOrCancellation
import com.nomanr.components.internal.minimumInteractiveComponentSize
import com.nomanr.components.internal.pointerSlop
...
fun Slider(
    ...
    thumbSizeOnPress: DpSize = DpSize(thumbWidth, thumbHeight),
...
fun RangeSlider(
    ...
    val state = remember(steps, valueRange) {
        RangeSliderState(
            value.start, value.endInclusive, steps, onValueChangeFinished, valueRange
        )
    }
